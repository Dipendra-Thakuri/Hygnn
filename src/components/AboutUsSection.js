    ...
    <Section id="about-us">
      <Container>
        ...
        <RightCol>
          ...
          <Subtitle>
            We bring everything your business needs to stay truly hygienic under one roof.
             From trusted hygiene products to expert on-site services and powerful digital tools,
              Hygnn delivers a complete ecosystem designed to elevate cleanliness, reduce risks, and support seamless operations.
          </Subtitle>
        </RightCol>
      </Container>
    </Section>
